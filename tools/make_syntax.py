...
def generate_variables(theme: dict, source: str) -> str:
    ...
    return (
        ...
        "@syntax-color-added:                        "
        ".hue-from-color(green, @syntax-cursor-color)[@result];\n"
        "@syntax-color-modified:                     "
        ".hue-from-color(orange, @syntax-cursor-color)[@result];\n"
        "@syntax-color-removed:                      "
        ".hue-from-color(red, @syntax-cursor-color)[@result];\n"
        "@syntax-color-renamed:                      "
        ".hue-from-color(blue, @syntax-cursor-color)[@result];\n"
        "\n"
        ...
        "@terminal-color-red:                        "
        f"if(@base2tone-colorfulTerminal, .hue-from-color(red, @syntax-cursor-color)[@result], {color_red});\n"
        "@terminal-color-green:                      "
        f"if(@base2tone-colorfulTerminal, .hue-from-color(green, @syntax-cursor-color)[@result], {color_green});\n"
        "@terminal-color-yellow:                     "
        f"if(@base2tone-colorfulTerminal, .hue-from-color(yellow, @syntax-cursor-color)[@result], {color_yellow});\n"
        "@terminal-color-blue:                       "
        f"if(@base2tone-colorfulTerminal, .hue-from-color(blue, @syntax-cursor-color)[@result], {color_blue});\n"
        "@terminal-color-magenta:                    "
        f"if(@base2tone-colorfulTerminal, .hue-from-color(magenta, @syntax-cursor-color)[@result], {color_magenta});\n"
        "@terminal-color-cyan:                       "
        f"if(@base2tone-colorfulTerminal, .hue-from-color(cyan, @syntax-cursor-color)[@result], {color_cyan});\n"
